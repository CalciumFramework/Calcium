package md5120d3125514cf9f936fe544f4c5c1a91;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Codon.GeoLocation.GeoLocator, Codon.Extras.Platform, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", GeoLocator.class, __md_methods);
	}
	...
	public GeoLocator () throws java.lang.Throwable
	{
		...
		if (getClass () == GeoLocator.class)
			mono.android.TypeManager.Activate ("Codon.GeoLocation.GeoLocator, Codon.Extras.Platform, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
