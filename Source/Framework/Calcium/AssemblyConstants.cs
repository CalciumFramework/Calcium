namespace Codon
{
	...
	/// <see cref="InversionOfControl.DefaultTypeNameAttribute"/>.
	/// </summary>
	static class AssemblyConstants
	{
		internal const string Namespace = nameof(Codon);
		internal const string PlatformAssembly = nameof(Codon) + ".Platform";
		internal const string ExtrasPlatformAssembly = nameof(Codon) + ".Extras.Platform";
